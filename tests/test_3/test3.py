...
def client_3():
    ...
    for i in range(0, 3):
        ...
        if operation == 'search':
            ...
            query_url = local_url + '/' + str(operation) + '/' + str(topic)
            request_result = requests.get(url=query_url, data={'request_id': request_id})
            file = open("client_3_output.txt", "a+")
            file.write(request_result.text)
            file.close()
            request_end = datetime.datetime.now()
            request_time = request_end - request_start
            total_request_time = total_request_time + (request_time.microseconds / 1000)
            request_counter = request_counter + 1
            file = open("client_3_metrics.txt", "a+")
            file.write("{} \t\t\t {}\n".format(request_id, (request_time.microseconds / 1000)))
            file.close()
...
def client_4():
    ...
    for i in range(0, 3):
        ...
        if operation == 'search':
            ...
            query_url = local_url + '/' + str(operation) + '/' + str(topic)
            request_result = requests.get(url=query_url, data={'request_id': request_id})
            file = open("client_4_output.txt", "a+")
            file.write(request_result.text)
            file.close()
            request_end = datetime.datetime.now()
            request_time = request_end - request_start
            total_request_time = total_request_time + (request_time.microseconds / 1000)
            request_counter = request_counter + 1
            file = open("client_4_metrics.txt", "a+")
            file.write("{} \t\t\t {}\n".format(request_id, (request_time.microseconds / 1000)))
            file.close()
...
def client_5():
    ...
    for i in range(0, 3):
        ...
        if operation == 'search':
            ...
            query_url = local_url + '/' + str(operation) + '/' + str(topic)
            request_result = requests.get(url=query_url, data={'request_id': request_id})
            file = open("client_5_output.txt", "a+")
            file.write(request_result.text)
            file.close()
            request_end = datetime.datetime.now()
            request_time = request_end - request_start
            total_request_time = total_request_time + (request_time.microseconds / 1000)
            request_counter = request_counter + 1
            file = open("client_5_metrics.txt", "a+")
            file.write("{} \t\t\t {}\n".format(request_id, (request_time.microseconds / 1000)))
            file.close()
